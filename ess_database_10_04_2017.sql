...
Target Database: seeton_mis
Date: 10/4/2017 10:35:22 AM
*/
...
CREATE TABLE `sis_admission_entry` (
  `id` int(11) NOT NULL,
  `pi_id` int(11) DEFAULT NULL,
  `sis_admission_entry_status_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- ----------------------------
-- Table structure for sis_admission_entry_statuses
-- ----------------------------
DROP TABLE IF EXISTS `sis_admission_entry_statuses`;
CREATE TABLE `sis_admission_entry_statuses` (
  `id` int(11) NOT NULL,
...
INSERT INTO `users` VALUES ('1', 'Mark-Arjay Bonus', 'arjayrozulbonus@gmail.com', '$2y$10$aSIzrPOtGHaa.V//Gfu86OTfCjp75QIFUvHNO3R2ltP6FpY8fpMvK', 'wPmHeLPvii0aranGAKYT9XhTn3x4wl5F0g9zWILiezFGWnHog52NcC8TOYaT', '2017-09-21 06:44:10', '2017-09-21 06:44:10');
